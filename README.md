...
1. Open proof_of_life.ipynb in Google Colab
2. Run the code cell to upload the site_inspection_log.csv file
3. Click *Runtime*>*Restart and Run all* to execute the notebook from top to bottom
4. The expected outputs (4,17 and 4 rows) will be displayed below the cells
